#[cfg(test)]
pub mod tests {
    use arrow::datatypes::{DataType, Field, TimeUnit, UnionFields, UnionMode};
    use std::sync::Arc;
    ...
    #[test]
    fn test_null() {
        let field = Field::new("test_field", DataType::Null, false);
    ...
    fn test_integers() {
        ...
        for data_type in integer_types {
            let field = Field::new("test_field", data_type.clone(), false);
            let result = round_trip_field(&field);
            assert_eq!(field, result);
        }
    }
    ...
    fn test_fixed_size_binary() {
        ...
        for size in sizes {
            ...
            let field = Field::new("test_field", data_type, false);
            let result = round_trip_field(&field);
            assert_eq!(field, result);
        }
    }
    ...
    fn test_field_metadata() {
        ...
        let field =
            Field::new("test_field", DataType::Int32, false).with_metadata(metadata.clone());
        let result = round_trip_field(&field);
        assert_eq!(field, result);
    }
    ...
    #[test]
    fn test_nullable() {
        let nullable_field = Field::new("test_field", DataType::Int32, true);
        let non_nullable_field = Field::new("test_field", DataType::Int32, false);
